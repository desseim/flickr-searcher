...
/*package*/ class ImageSearchViewController {
    ...
    public void onImageSearch(final SearchView searchView, final CompoundButton includeLocationView, final String query, final @Nullable LocationData lastLocation) {
        ...
        mImageSearchRecentSuggestions.saveRecentQuery(query, null);
    }
